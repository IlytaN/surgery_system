<!-- bootstrap has been used here to make the design more modern/profressional looking -->
<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
<div class="container"
     style="background-image:url(<?= base_url('surgery_system-develop/assets/imgs/login_photo.jpg') ?>);
             width: 100%;
    ...
    <div class="row" style="margin-top: 10%">
        <div class="col-md-6 col-md-offset-3" style="background-color: #ddddddcf; padding: 40px;">
            <!--This is initialised  the form  where action : login is the function name in the login controller-->
            <?= form_open('login'); ?>
            ...
            <div class="form-group text-center">
                <div class="user-types row text-center">
                    <div class="col-md-6">
                        ...
                        <!-- Images are based encoded here for faster loading, icons were given in BASE64 -->
            ...
            <!-- this is used to pass back the error data from the login form error validation -->
            <!-- TODO : need to fix  for this part to work -->
